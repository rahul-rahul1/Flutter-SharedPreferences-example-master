...
class _LoginPageState extends State<LoginPage> {
  ...
  _onChanged(bool value) async {
    ...
    setState(() {
      print('@@checkValue__4'+value.toString());

      checkValue = value;
      print('@@checkValue__5'+checkValue.toString());
  ...
  getCredential() async {
    ...
    setState(() {
      ...
      print('@@checkValue__1'+checkValue.toString());
      if (checkValue != null) {
        print('@@checkValue__2'+checkValue.toString());

        if (checkValue) {
          print('@@checkValue__3'+checkValue.toString());

          username.text = sharedPreferences.getString("username");
          password.text = sharedPreferences.getString("password");
        } else {

          print('@@checkValue__4'+checkValue.toString());
